...
check("28 manifest version marks this tree as v1.2.1 clinical hardening, not the 1.2.0 release",
      manifest["version"] == "1.2.1-clinical-hardening", manifest["version"])
