...
This is the CANONICAL copy (evidence-research owns this reference). The bundled copy in
skills/start/references/connector-capability-map.md must be re-synced whenever this file changes.
